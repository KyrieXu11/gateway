...
public class AccessLimitAspect {
    ...
    @Around("(execution(public * *(..)) && @within(com.kyriexu.annotation.InternalAccess)) || @annotation(com.kyriexu.annotation.InternalAccess)")
    public Object internalAccess(ProceedingJoinPoint joinPoint) throws Throwable {
