        ...
        <div style="margin-bottom:50px;">
          <el-form ref="form" :model="form" label-width="140px">
            ...
            <el-form-item label="接入类型" class="is-required">
              <el-input v-model="form.rule" :disabled="isEdit===true" placeholder="路径格式：/user/,域名格式：www.test.com"
            ...
            <el-form-item label="URL重写">
              <el-input v-model="form.url_rewrite" type="textarea" autosize
                        placeholder="格式：^/gateway/test_service(.*) $1 多条换行"
              />
            </el-form-item>
            <el-form-item label="Header转换">
              <el-input v-model="form.header_transfor" type="textarea" autosize
            ...
            <el-form-item v-show="isWeight" label="权重列表" class="is-required">
...
<script>
import { addHttpService, serviceDetail, updateHttpService } from '@/api/service'
...
export default {
  ...
  watch: {
    round_type: function(newVal, oldVal) {
      if (newVal !== 2) {
