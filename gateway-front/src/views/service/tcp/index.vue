        ...
        <el-card class="box-card" style="margin-bottom:20px;">
          ...
          <div>
            ...
            <el-form-item label="IP白名单">
              <el-input v-model="form.white_list" placeholder="格式: 127.0.0.1 多条换行，白名单优先级高于黑名单" type="textarea"
                        :autosize="{ minRows: 2, maxRows: 20}"
              />
            </el-form-item>

            <el-form-item label="IP黑名单">
              <el-input v-model="form.black_list" placeholder="格式: 127.0.0.1 多条换行" type="textarea"
                        :autosize="{ minRows: 2, maxRows: 20}"
              />
            </el-form-item>
            ...
            <el-form-item label="IP列表" class="is-required">
              <el-input v-model="form.ip_list" placeholder="格式: 127.0.0.1:80 多条换行" type="textarea"
                        :autosize="{ minRows: 2, maxRows: 20}"
              />
            </el-form-item>

            <el-form-item label="权重列表" class="is-required">
              <el-input v-model="form.weight_list" placeholder="格式: 50 多条换行" type="textarea"
                        :autosize="{ minRows: 2, maxRows: 20}"
              />
            </el-form-item>
